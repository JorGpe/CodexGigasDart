...
class EulerSistemasForm extends StatefulWidget {
  const EulerSistemasForm({super.key});

  @override
  State<EulerSistemasForm> createState() => _EulerSistemasFormState();
}

class _EulerSistemasFormState extends State<EulerSistemasForm> {
  ...
  Future<void> _callEulerSistemasApi() async {
    setState(() {
      isLoading = true;
      result = [];
      error = '';
    ...
    try {
      ...
      //       (responseData['result'] as List)[0] is List // Check if the first element is a list
      //       ) {
      //     setState(() {
            ...
            children: <Widget>[
              TextField(
                ...
                decoration: const InputDecoration(
                  ...
                  hintText: 'e.g., y[1]\n-0.1*y[1] - y[0]', // Example for 2 functions/variables
              ...
              ElevatedButton(
                onPressed: isLoading ? null : _callEulerSistemasApi,
                child: isLoading
                    ? const CircularProgressIndicator()
                    : const Text('Calcular y(tₙ) con Euler (Sistemas)'),
              ),
              const SizedBox(height: 16.0),
              // Display results
...
Future<Map<String, dynamic>> callEulerSistemas(
