...
class EulerCauchySistemasForm extends StatefulWidget {
  const EulerCauchySistemasForm({super.key});

  @override
  State<EulerCauchySistemasForm> createState() =>
      _EulerCauchySistemasFormState();
}

class _EulerCauchySistemasFormState
    extends State<EulerCauchySistemasForm> {
  ...
  Future<void> _callEulerCauchySistemasApi() async {
    setState(() {
      isLoading = true;
      result = [];
      error = '';
            ...
            children: <Widget>[
              TextField(
                ...
                decoration: const InputDecoration(
                  ...
                  hintText: 'e.g., y[1]\n-y[0] - 0.5*y[1]', // Example for 2 functions
              ...
              ElevatedButton(
                onPressed: isLoading ? null : _callEulerCauchySistemasApi,
                child: isLoading
                    ? const CircularProgressIndicator()
                    : const Text('Calcular y(tₙ) con Euler-Cauchy (Sistemas)'),
              ),
              const SizedBox(height: 16.0),
              // Display results
...
Future<Map<String, dynamic>> callEulerCauchySistemas(
