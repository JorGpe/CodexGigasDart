...
class RungeKuttaModificadoSistemasForm extends StatefulWidget {
  const RungeKuttaModificadoSistemasForm({super.key});

  @override
  State<RungeKuttaModificadoSistemasForm> createState() =>
      _RungeKuttaModificadoSistemasFormState();
}

class _RungeKuttaModificadoSistemasFormState
    extends State<RungeKuttaModificadoSistemasForm> {
  ...
  Future<void> _callRungeKuttaModificadoSistemasApi() async {
    setState(() {
      isLoading = true;
      result = [];
      error = '';
    ...
    try {
      ...
      setState(() {
          result = ["1.4468903245921956", "-0.7904424185131915"];
          isLoading = false;
      });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'RK (Euler Modificado) Sistemas', // Shortened title for AppBar
            ...
            children: <Widget>[
              TextField(
                ...
                decoration: const InputDecoration(
                  ...
                  hintText: 'e.g., y[1]\n-y[0]', // Example for 2 functions/variables
              ...
              ElevatedButton(
                onPressed: isLoading ? null : _callRungeKuttaModificadoSistemasApi,
                child: isLoading
                    ? const CircularProgressIndicator()
                    : const Text('Calcular y(tₙ) con RK (Modificado) Sistemas'),
              ),
              const SizedBox(height: 16.0),
              // Display results
...
Future<Map<String, dynamic>> callRungeKuttaModificadoSistemas(
