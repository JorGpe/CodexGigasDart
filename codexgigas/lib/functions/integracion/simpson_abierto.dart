...
class SimpsonAbiertoN2Form extends StatefulWidget {
  const SimpsonAbiertoN2Form({super.key});

  @override
  State<SimpsonAbiertoN2Form> createState() => _SimpsonAbiertoN2FormState();
}

class _SimpsonAbiertoN2FormState extends State<SimpsonAbiertoN2Form> {
  ...
  Future<void> _callSimpsonAbiertoN2Api() async {
    setState(() {
      isLoading = true;
      result = [];
      error = '';
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              ElevatedButton(
                onPressed: isLoading ? null : _callSimpsonAbiertoN2Api,
                child: isLoading
                    ? const CircularProgressIndicator()
                    : const Text('Calcular Integral (Simpson Abierto N=2)'),
              ),
              const SizedBox(height: 16.0),
...
Future<Map<String, dynamic>> callSimpsonAbiertoN2(
