...
class GaussLegendreN2Form extends StatefulWidget {
  const GaussLegendreN2Form({super.key});

  @override
  State<GaussLegendreN2Form> createState() => _GaussLegendreN2FormState();
}

class _GaussLegendreN2FormState extends State<GaussLegendreN2Form> {
  ...
  Future<void> _callGaussLegendreN2Api() async {
    setState(() {
      isLoading = true;
      result = [];
      error = '';
    ...
    try {
      ...
      final Uri uri = Uri.parse('http://127.0.0.1:5000/gauss_legendre_n2');
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              ElevatedButton(
                onPressed: isLoading ? null : _callGaussLegendreN2Api,
                child: isLoading
                    ? const CircularProgressIndicator()
                    : const Text('Calcular Integral (Gauss-Legendre N=2)'),
              ),
              const SizedBox(height: 16.0),
...
Future<Map<String, dynamic>> callGaussLegendreN2(
