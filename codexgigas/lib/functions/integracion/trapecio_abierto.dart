...
class TrapecioAbiertoN1Form extends StatefulWidget {
  const TrapecioAbiertoN1Form({super.key});

  @override
  State<TrapecioAbiertoN1Form> createState() => _TrapecioAbiertoN1FormState();
}

class _TrapecioAbiertoN1FormState extends State<TrapecioAbiertoN1Form> {
  ...
  Future<void> _callTrapecioAbiertoN1Api() async {
    setState(() {
      isLoading = true;
      result = [];
      error = '';
    ...
    try {
      ...
      final Uri uri = Uri.parse('http://127.0.0.1:5000/trapecio_abierto_n1');
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              ElevatedButton(
                onPressed: isLoading ? null : _callTrapecioAbiertoN1Api,
                child: isLoading
                    ? const CircularProgressIndicator()
                    : const Text('Calcular Integral (Trapecio Abierto N=1)'),
              ),
              const SizedBox(height: 16.0),
...
Future<Map<String, dynamic>> callTrapecioAbiertoN1(
