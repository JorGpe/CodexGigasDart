...
class SimpsonTresOctavosForm extends StatefulWidget {
  const SimpsonTresOctavosForm({super.key});

  @override
  State<SimpsonTresOctavosForm> createState() => _SimpsonTresOctavosFormState();
}

class _SimpsonTresOctavosFormState extends State<SimpsonTresOctavosForm> {
  ...
  Future<void> _callSimpsonTresOctavosApi() async {
    setState(() {
      isLoading = true;
      result = [];
      error = '';
    ...
    try {
      ...
      // final Uri uri = Uri.parse('http://127.0.0.1:5000/simpson_tres_octavos');
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              ElevatedButton(
                onPressed: isLoading ? null : _callSimpsonTresOctavosApi,
                child: isLoading
                    ? const CircularProgressIndicator()
                    : const Text('Calcular Integral (Simpson 3/8)'),
              ),
              const SizedBox(height: 16.0),
...
Future<Map<String, dynamic>> callSimpsonTresOctavos(
